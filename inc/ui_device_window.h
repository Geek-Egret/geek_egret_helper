...
public:
    ...
    void setupUi(QWidget *deviceWindow)
    {
        ...
        deviceWindow->setWindowIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/ui/ui_img/previous.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/ui/ui_img/next.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        next->setIcon(icon2);
